...
const CheckoutPage = () => {
  ...
  const makePurchase = async () => {
    if (
      ...
      const response = fetch("https://ecommerce-api-58ck.onrender.com/api/orders", {
        method: "POST",
        headers: {
  ...
  const addOrderProduct = async (
    ...
    const response = await fetch("https://ecommerce-api-58ck.onrender.com/api/order-product", {
      method: "POST", // or 'PUT'
      headers: {
        "Content-Type": "application/json",
      },
